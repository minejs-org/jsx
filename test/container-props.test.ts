...
// ╔════════════════════════════════════════ TEST ════════════════════════════════════════╝
    ...
    describe('Container Props Integration', () => {
        ...
        test('handles color and background', () => {
            const el = jsx('div', { bg: 'error', color: 'inverse' }) as HTMLElement;
            expect(el.className).toContain('bg-error');
            expect(el.className).toContain('text-inverse');
        });

        test('handles border props', () => {
            const el = jsx('div', { border: 2, borderColor: 'brand', radius: 'lg' }) as HTMLElement;
